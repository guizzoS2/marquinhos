...
const navItems = [
  { to: '/freela', label: 'Histórico', icon: 'history', end: true },
  { to: '/freela/vagas', label: 'Vagas e propostas', icon: 'work' },
  { to: '/freela/perfil', label: 'Perfil', icon: 'badge' },
  { to: '/freela/financeiro', label: 'Recebimentos', icon: 'account_balance' },
];

const titles = {
  '/freela': 'Histórico e avaliações',
  '/freela/vagas': 'Vagas e propostas',
  '/freela/perfil': 'Perfil profissional',
  '/freela/financeiro': 'Recebimentos Stripe',
};
...
export function FreelaLayout() {
  ...
  const title =
    titles[location.pathname] || (isChat ? 'Negociação' : 'Painel do freela');
      ...
      >
        ...
        <div className="pt-4 border-t border-outline-variant/20 space-y-2">
          ...
          <p className="px-3 text-xs text-on-surface-variant">
            Sem acesso ao caixa ou estoque do bar.
          </p>
